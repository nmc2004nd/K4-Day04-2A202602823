...
- You MUST use the `clarify` tool to ask for explicit confirmation (response_type: 'yes_no') BEFORE calling `create_ticket`, UNLESS the user explicitly confirms it in their current message (e.g., 't├┤i x├íc nhß║¡n tß║ío').
